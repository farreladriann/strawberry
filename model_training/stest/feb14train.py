...
def train_strawberry_leaves_model():
    ...
    config = {
        'data': '/data/strawberry-2/data.yaml',  # Path to your dataset YAML file
        ...
        'project': 'strawberry14feb',  # Save to project/name
        'name': 'strawberry14feb',  # Save to project/name
    ...
    model.save('strawberry14feb.pt')

def validate_model():
    # Load the trained modelso what is the best configuration
    model = YOLO('strawberry14feb.pt')
